...
void AxHessian(struct gwig *pWig, double *Xvec, double *pax);
void AyHessian(struct gwig *pWig, double *Xvec, double *pay);
void Hessian(struct gwig *pWig, double *Xvec, double *H2);
